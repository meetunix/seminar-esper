...
\subsection{Die Anfragesprache EPL}
\vspace{0.1cm}
...
Um die in Sektion \ref{kap:ereignisregeln} erwähnten ereignistypbasierten Muster in EPL 
zu verwenden existiert das Schlüsselwort \texttt{pattern[]}.

%TBD
% einfache ereignistypbasierte Anfragen
% consumption modes
% -> Operator
% -> Operator mit Fenstern
% -> Operator mit Kontextbedingungen
% -> Beispiel SocialMedia hat Einfluss auf Aktienkurs?
