...
StockTick={symbol='RHAT', price=95}
...
\texttt{select c from pattern[a=StockTick(symbol='IBM') ->\\
    ...
    c=StockTick(symbol='IBM' and\\ price < a.price)].win:time\_batch(30sec);}

In diesem Beispiel wird neben einer kontextabhängigen Bedingung (\texttt{proce < 
a.price}), auch nur ein Zeitraum von 30 Sekunden betrachtet.
